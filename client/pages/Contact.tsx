      ...
      <div className="grid gap-8 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-border bg-card/60 p-6 text-center">
          <div className="mx-auto inline-flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
            ...
            >
              <path
                d="M22 16.92V21a1 1 0 0 1-1.11 1 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2 3.11 1 1 0 0 1 3 2h4.09a1 1 0 0 1 1 .75c.12.62.34 1.6.63 2.7a1 1 0 0 1-.24 1l-1.3 1.3a16 16 0 0 0 6 6l1.3-1.3a1 1 0 0 1 1-.24c1.1.29 2.08.51 2.7.63a1 1 0 0 1 .75 1V21z"
                strokeLinecap="round"
        ...
        <div className="rounded-2xl border border-border bg-card/60 p-6 text-center">
          <div className="mx-auto inline-flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
            ...
            >
              <path
                d="M21 10c0 6-9 11-9 11S3 16 3 10a9 9 0 1 1 18 0z"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
      ...
      <div className="mt-10 grid gap-8 md:grid-cols-2">
        ...
        >
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <input
              ...
              className="rounded-md border border-border bg-background/5 px-3 py-2 text-sm w-full"
            />
            <input
              value={email}
          ...
          <textarea
            ...
            placeholder="Message"
            className="mt-4 h-40 w-full rounded-md border border-border bg-background/5 px-3 py-2 text-sm"
          />
          <div className="mt-4">
            <button className="inline-block rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground">
              Send Message
            </button>
          </div>
        </form>
        ...
        <div className="rounded-2xl border border-border bg-card/60 p-6">
          ...
          <p className="mt-3 text-sm text-muted-foreground text-center">
            ...
            your ideas to life with cutting-edge technology and innovative
            solutions.
          </p>
...
>>>>>>> fe741c72be8e75d1dd5df35f0dfec6993f69a550
          </div>
