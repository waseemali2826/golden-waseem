      ...
      <div className="mt-10 grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-border bg-card/60 p-6">
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <a className="rounded-md border border-border px-3 py-2 text-sm text-muted-foreground" href="https://www.instagram.com/waseemali3145/?igsh=YzljYTk1ODg3Zg%3D%3D" >Instagram</a>
          </div>
