...
const certs = [
  ...
  },
  {
    ...
    img: "/Meal Essential.webp",
  },
  {
    title: "Create Your Own ChatGPT with PDF",
    subtitle: "Custom LLM App",
    img: "/creategpt.webp",
  },
  {
    ...
    <div className="container mx-auto py-16">
      <header className="mb-8 text-center" data-animate>
        ...
        <p className="mt-2 text-muted-foreground">
          Verified certificates and course achievements. Click the image to
          preview.
        </p>
      </header>
      ...
      {active !== null ? (
        ...
        >
          ...
          <div className="z-10 w-full h-full flex items-center justify-center p-4">
            <button
              className="absolute top-6 right-6 z-20 rounded-full bg-black/50 p-2 text-white"
              onClick={() => setActive(null)}
            ...
            <img
              ...
              className="max-h-[95vh] max-w-[95vw] object-contain shadow-lg z-10"
            />
          </div>
        </div>
      ) : null}
