...
const projects = [
  {
    title: "TechHubReact",
    subtitle:
      "A platform to discover and share developer tools, tutorials, and starter kits.",
  ...
  },
  {
    ...
    subtitle:
      "ML-based app that predicts depression likelihood from questionnaire or text-derived features.",
  ...
  },
  {
    ...
    subtitle:
      "Generate practice papers and question sets automatically with customizable topics and difficulty.",
  ...
  },
  {
    ...
    subtitle:
      "Platform for NFC students to access datasets, explore visualizations, and interactive tools.",
  ...
  },
  {
    ...
    subtitle:
      "Versatile online platform offering text and utility tools such as formatting and analysis.",
  ...
  },
  {
    ...
    subtitle:
      "Advanced text-to-speech conversion application with multiple voice options.",
  ...
  },
  {
    ...
    subtitle:
      "AI-powered background removal tool using ML algorithms for image segmentation.",
  ...
  },
  {
    ...
    subtitle:
      "Modern coffee shop website with interactive menu and online ordering.",
  ...
  },
  {
    ...
    subtitle:
      "Classic Flappy Bird recreation with smooth animations and scoring.",
  ...
  },
  {
    title: "T-Shirt Store",
    subtitle:
      "E-commerce site for T-shirts with responsive layout and cart functionality.",
  ...
  },
  {
    title: "skyzenic-live",
    subtitle:
      "Real-time weather application with forecasting and interactive maps.",
  ...
  },
  {
    ...
    subtitle:
      "Interactive dashboard for car performance data with real-time analytics.",
  ...
  },
  {
    ...
    subtitle:
      "E-commerce website for furniture with 3D product views and shopping cart.",
    ...
    <div className="container mx-auto py-16">
            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {p.tech.map((t) => (
                  <span
                    key={t}
                    className="inline-block rounded-full border border-border px-2 py-1 text-xs text-muted-foreground"
                  >
                    {t}
                  </span>
                ))}
      ...
      <div className="mt-10 text-center">
        <p className="text-sm text-muted-foreground">
          Want to add live links or deploy demos? Send project links and I'll
          wire them up.
        </p>
      </div>
    </div>
