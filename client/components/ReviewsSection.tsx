...
const REVIEWS = [
  {
    ...
    text: "Waseem delivered a fantastic dashboard that helped our team make data-driven decisions. Highly recommend!",
    rating: 5,
  },
  {
    name: "Bilal Ahmed",
    role: "CTO",
    text: "Fast, communicative and delivered exactly what we needed. Clean code and great attention to detail.",
    rating: 5,
  },
  {
    name: "Sara Ali",
    role: "Data Scientist",
    text: "Great at turning messy data into actionable insights. Excellent ML skills.",
    rating: 5,
  },
  {
    name: "Hamza Raza",
    role: "Founder",
    text: "Delivered an MVP quickly and iterated based on feedback. Very professional.",
    rating: 4,
  },
  {
    name: "Zainab Noor",
    role: "Lead Engineer",
    text: "Solid frontend engineering and thoughtful UX suggestions.",
    rating: 5,
  },
  {
    name: "Omar Malik",
    role: "Researcher",
    text: "Impressive ML prototypes and reproducible pipelines.",
    rating: 4,
  },
  {
    name: "Mona Farooq",
    role: "Analyst",
    text: "Excellent visualizations and clear documentation.",
    rating: 5,
  },
  {
    name: "Faisal Khan",
    role: "CEO",
    text: "Reliable and delivered on time. Would hire again.",
    rating: 5,
  },
  {
    name: "Rizwan Shah",
    role: "Engineer",
    text: "Good communicator and quick to resolve issues.",
    rating: 4,
  },
  {
    name: "Nadia Iqbal",
    role: "Designer",
    text: "Helped polish the UI and made the product more appealing.",
    rating: 5,
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="rounded-2xl border border-border bg-card/60 p-8">
          <h2 className="font-serif text-2xl text-primary text-center">
            What people say — Project reviews
          </h2>
          <p className="mt-2 text-center text-muted-foreground">
            Feedback specific to delivered projects and outcomes
          </p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1" aria-hidden>
                    {Array.from({ length: 5 }).map((_, si) => (
                      <svg
                        key={si}
                        className={`h-4 w-4 ${si < r.rating ? "text-primary" : "text-muted-foreground/50"}`}
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
