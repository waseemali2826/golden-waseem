...
export default function ToolsSection() {
  return (
    <section className="container mx-auto py-12" aria-labelledby="tools-heading">
      <div className="rounded-2xl border border-border bg-card/60 p-8">
        <h2 id="tools-heading" className="font-serif text-2xl text-primary text-center">Tools</h2>
        <p className="mt-2 text-sm text-muted-foreground text-center">A quick overview of the tooling and utilities used across projects.</p>
